...
from service.views import  get_42_auth_url, oauth_callback, get_user_id_from_cookie, login_view, protected_view, check_auth_view, logout_view, verify_2fa_view

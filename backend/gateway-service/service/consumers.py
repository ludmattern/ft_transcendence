...
class GatewayConsumer(AsyncWebsocketConsumer):
	...
	async def info_message(self, event):
		...
		if (action == "back_tournament_invite" or action == "back_join_tournament" or action == "back_reject_tournament" or action == "back_cancel_tournament_invite" or action == "back_kick_tournament" or action == "back_cancel_tournament"):
			await self.channel_layer.group_send("chat_service", event)

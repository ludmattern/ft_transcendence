...
function createLinearGradient(id, x1, y1, x2, y2, stops, gradientTransform = null) {
...
function createTopLeftSVG() {
  return createSVGElement(
    ...
    createElement('defs', {},
      createLinearGradient('tlg1', '45.6', '2.45', '45.6', '275.34', [
      ...
      createLinearGradient('tlg2', '47.44', '0', '47.44', '246.62', [
      ...
      createLinearGradient('tlg3', '50.47', '2.67', '50.47', '254.44', [
...
function createTopRightSVG() {
  return createSVGElement(
    ...
    createElement('defs', {},
      createLinearGradient('trg1', '-2685.6', '2.45', '-2685.6', '275.34', [
        { offset: '0', stopColor: '#07111b' },
        { offset: '0.27', stopColor: '#2a4e66' },
        { offset: '0.37', stopColor: '#6d8c9d' },
        { offset: '0.45', stopColor: '#a4c0cb' },
      ...
      createLinearGradient('trg2', '-2683.76', '0', '-2683.76', '246.62', [
        { offset: '0', stopColor: '#0f1d28' },
        { offset: '0.06', stopColor: '#1c2c38' },
        { offset: '0.19', stopColor: '#314552' },
        { offset: '0.33', stopColor: '#425966' },
	...
	'matrix(-1, 0, 0, 1, -2630.38, 0)'
      ...
      createLinearGradient('trg3', '-2680.73', '2.67', '-2680.73', '254.44', [
        { offset: '0', stopColor: '#25414f' },
        { offset: '0.3', stopColor: '#8b9da3' },
        { offset: '0.54', stopColor: '#dce6e7' },
      ],
...
function createBottomLeftSVG() {
	return createSVGElement(
	  ...
	  createElement(
		'defs',
		{},
		createLinearGradient('blg1', '7.92', '46.32', '187.27', '122.45', [
...
function createBottomRightSVG() {
	return createSVGElement(
	  ...
	  createElement('defs', {},
		createLinearGradient('brg1', '186.92', '46.32', '7.57', '122.45', [
		  { offset: '0', stopColor: '#c2d6df' },
		  { offset: '0.08', stopColor: '#bacfd8' },
		  { offset: '0.19', stopColor: '#a5bbc6' },
		  { offset: '0.33', stopColor: '#829ba8' },
		...
		createLinearGradient('brg2', '178.82', '41.81', '34.92', '142.57', [
		  { offset: '0', stopColor: '#b4cfda' },
		  { offset: '0.04', stopColor: '#a6bfcb' },
		  { offset: '0.25', stopColor: '#556775' },
		  { offset: '0.39', stopColor: '#233040' },
		...
		createLinearGradient('brg3', '194.84', '84.94', '11.13', '84.94', [
		  { offset: '0', stopColor: '#476172' },
		  { offset: '0.54', stopColor: '#213c4d' },
		  { offset: '0.77', stopColor: '#465c69' },
		  { offset: '1', stopColor: '#355a6d' },
...
function createBottomCenterSVG() {
	return createSVGElement(
		...
		createElement(
		  'defs',
		  {},
		  createLinearGradient('bcg1', '1.07', '22.94', '570.45', '22.94', [
		  ...
		  createLinearGradient('bcg2', '2.03', '20.78', '571.66', '20.78', [
		  ...
		  createLinearGradient('bcg3', '0', '18.03', '572.84', '18.03', [
		...
		createElement(
		  ...
		  createElement(
			...
			createElement('polygon', {
			  className: 'bc-1',
			  points: '568.79 36.06 1.31 36.06 1.49 35.79 285.01 14.08 568.61 35.8 568.79 36.06',
			}),
			createElement('polygon', {
			  className: 'bc-2',
			  points: '570.45 36.06 568.79 36.06 568.61 35.8 285.01 14.08 1.49 35.79 1.31 36.06 1.07 36.06 2.03 34.22 285.4 9.81 569.38 34.28 570.45 36.06',
			}),
			createElement('polygon', {
			  className: 'bc-3',
			  points: '571.66 36.06 570.45 36.06 569.38 34.28 285.4 9.81 2.03 34.22 2.43 33.47 286.33 5.5 570.31 33.48 571.66 36.06',
			}),
			createElement('polygon', {
			  className: 'bc-4',
			  points: '572.84 36.06 571.66 36.06 570.31 33.48 286.33 5.5 2.43 33.47 2.03 34.22 1.5 34.27 0.43 36.06 0 36.06 2.49 30.82 286.47 0 286.39 0.02 570.36 30.84 572.84 36.06',
			})
		  )
		)
	  );

  ...
  return createElement(
    ...
    createElement(
      ...
      createElement(
        "button",
        {
          className: "btn btn-back mt-0 pt-2 pb-2 ps-3 pe-3",
          onClick: () => {
            handleRoute("/");
...
function SoloContent() {
  return createElement(
    ...
    createElement(
      ...
      createElement(
        "button",
        { className: "btn btn-primary mt-3", id: "launch" },
        "Launch"
      )
    )
  );
...
function LocalSoloTabs() {
  return createElement(
    ...
    createElement(
      "ul",
      {
        className: "nav nav-pills mb-4 mt-5 topcontent",
        id: "soloLocalTabs",
        role: "tablist",
      },
      createElement(
...
function MpPrivateContent() {
  return createElement(
    ...
    createElement(
      ...
      {
        className: "form-select mb-3",
        "aria-label": "Map selector multiplayer private",
      },
      createElement("option", { value: "map1" }, "Map 1"),
      createElement("option", { value: "map2" }, "Map 2"),
      createElement("option", { value: "map3" }, "Map 3")
              ...
              createElement(
                ...
                createElement(
                  ...
                  createElement(
                    "button",
                    {
                      className: "btn btn-primary btn-sm tab",
...
function PlaySection() {
  return createElement(
    ...
    createElement(
      ...
      createElement("div", { className: "col" }, PlayTabs())
    )
  );
}
    ...
    createElement(
      ...
      createElement(
        ...
        createElement(
          ...
          createElement(
            "button",
            { className: "btn btn-primary mb-5 leadbtn mt-5" },
            "Find me"
          ),
          createElement(
            "div",

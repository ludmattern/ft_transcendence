...
export function onBaseMouseMove(event) {
    ...
    Store.cameraRotation.y = THREE.MathUtils.clamp(
      Store.cameraRotation.y,
      Store.initialCameraRotation.y - maxRotationAngle,
      Store.initialCameraRotation.y + maxRotationAngle
    );
  
    Store.cameraRotation.x = THREE.MathUtils.clamp(
      Store.cameraRotation.x,
      Store.initialCameraRotation.x - maxRotationAngle / 2,
      Store.initialCameraRotation.x + maxRotationAngle / 2
    );
